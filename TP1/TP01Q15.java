class TP01Q15 {
    ...
    //método recursivo para ver se a palavra é composta apenas por vogais
    public static boolean isVogal(String palavra){
        return isVogal(palavra, 0);
    }

    //função que revela se a palavra é composta apenas por vogais
    ...
    //método recursivo para ver se a palavra é composta apenas por consoantes
    public static boolean isConsoante(String palavra){
        return isConsoante(palavra, 0);
    }

    //função que revela se a palavra é composta apenas por consoantes
    ...
    //método recursivo para ver se a string é composta por um número inteiro
    public static boolean isInteiro(String palavra){
        return isInteiro(palavra, 0);
    }

    //função que revela se a string é composta por um número inteiro
    ...
    //método recursivo para ver se a string é composta por um número real
    public static boolean isReal(String palavra){
        return isReal(palavra, 0);
    }

    //função que revela se a string é composta por um número real
