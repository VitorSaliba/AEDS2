...
class Lista {
    ...
    public void ordenarInsercao() {
        for (int i = 1; i < n; i++) {
            ...
            while ((j >= 0) && (listaSerie[j].getidiomaOriginal().compareTo(tmp.getidiomaOriginal())) > 0) {
    ...
    public void construir(int tamHeap) {
        for (int i = tamHeap; i > 1 && (listaSerie[i].getFormato().compareTo(listaSerie[i / 2].getFormato()) > 0 || (listaSerie[i].getFormato().compareTo(listaSerie[i / 2].getFormato()) == 0 && listaSerie[i].getNome().compareTo(listaSerie[i / 2].getNome()) > 0)); i /= 2) {
            swap(i, i / 2);
        }
    }
    ...
    public void reconstruir(int tamHeap) {
        ...
        while (i <= (tamHeap / 2)) {
            ...
            if (listaSerie[i].getFormato().compareTo(listaSerie[filho].getFormato()) < 0 || (listaSerie[i].getFormato().compareTo(listaSerie[filho].getFormato()) == 0 && listaSerie[i].getNome().compareTo(listaSerie[filho].getNome()) < 0) ) {
                swap(i, filho);
                i = filho;
            } else {
                i = tamHeap;
    ...
    public int getMaiorFilho(int i, int tamHeap){
        int filho;
        if (2*i == tamHeap || listaSerie[2*i].getFormato().compareTo(listaSerie[2*i+1].getFormato()) > 0 || (listaSerie[2*i].getFormato().compareTo(listaSerie[2*i+1].getFormato()) == 0 && listaSerie[2*i].getNome().compareTo(listaSerie[2*i+1].getNome()) > 0)){
           filho = 2*i;
        } else {
           filho = 2*i + 1;
        }
